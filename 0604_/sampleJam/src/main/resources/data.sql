...
create table jsaveDoc(id NUMBER, userId TEXT, docId NUMBER);
insert into jsaveDoc(id, userId, docId) values(1, 'abc', 1);
insert into jsaveDoc(id, userId, docId) values(2, 'ing', 2);
insert into jsaveDoc(id, userId, docId) values(3, 'ing', 3);

drop table jdoc;
create table jdoc(docId NUMBER, title TEXT, subtitle TEXT, ytb TEXT, context1 TEXT, context2 TEXT, rcmd NUMBER, rprt NUMBER, userId TEXT, mdfyDate DATE);
insert into jdoc(docId, title, subtitle, ytb, context1, context2, rcmd, rprt, userId, mdfyDate) values(1, '하여가', '음악대장님', 'nkWpCMIwyDc', '음악대장에대해', '갤러리주소', 10, 0, 'ing', '2016-06-04');
...
create table jDocRelation(docId NUMBER, keywordKo TEXT);
